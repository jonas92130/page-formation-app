...
export default async function ActualityCard(props: Props) {
  ...
  return (
    <Card
      className={cn(
        'min-h-[24dvh] w-full transform items-center overflow-hidden rounded-[12px] shadow-md transition-transform duration-300 ease-in-out hover:scale-95 hover:shadow-lg'
      )}
    >
